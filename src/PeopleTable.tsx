...
const PeopleTable: React.FC<Props> = ({ people, handleSord }) => {
  const location = useLocation();
  const searchParams = new URLSearchParams(location.search);
  const isSortedAsc = searchParams.get('sortOrder');
  const isSortBy = searchParams.get('sortBy');
    ...
    <>
      <table className="table table-borderless">
        <thead>
          <tr>
            <th
              className={classNames({ isActive: location.search === '?sortOrder=name' })}
              scope="col"
              onClick={() => handleSord('name')}
            >
              name
              {(isSortedAsc && isSortBy === 'name') && ((isSortedAsc === 'desc' && isSortBy === 'name')
                ? (
            ...
            <th
              className={classNames({ isActive: location.search === '?sortOrder=sex' })}
              scope="col"
              onClick={() => handleSord('sex')}
            >
              sex
              {(isSortedAsc && isSortBy === 'sex') && ((isSortedAsc === 'desc' && isSortBy === 'sex')
                ? (
                  <svg className="bi bi-chevron-double-up" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" d="M7.646 2.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 3.707 2.354 9.354a.5.5 0 1 1-.708-.708l6-6z" />
                    <path fillRule="evenodd" d="M7.646 6.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 7.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z" />
            ...
            <th
              ...
              scope="col"
              onClick={() => handleSord('born')}
            >
              born
              {(isSortedAsc && isSortBy === 'born') && ((isSortedAsc === 'desc' && isSortBy === 'born')
                ? (
                  <svg className="bi bi-chevron-double-up" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" d="M7.646 2.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 3.707 2.354 9.354a.5.5 0 1 1-.708-.708l6-6z" />
                    <path fillRule="evenodd" d="M7.646 6.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 7.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z" />
            ...
            <th
              ...
              scope="col"
              onClick={() => handleSord('died')}
            >
              died
              {(isSortedAsc && isSortBy === 'died') && ((isSortedAsc === 'desc' && isSortBy === 'died')
                ? (
                  <svg className="bi bi-chevron-double-up" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" d="M7.646 2.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 3.707 2.354 9.354a.5.5 0 1 1-.708-.708l6-6z" />
                    <path fillRule="evenodd" d="M7.646 6.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 7.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z" />
